 ...
 * components/domain/hrms/hrit/attendance-management/attendance-tracking/components/attendance-table-toolbar.tsx
 * (`TableToolbar`). Not part of the `_shared` set ported for the attendance
 * pages (that set covers 7 specific cross-page components); this one is only
 * consumed by `AttendanceReportTable`, so it is kept local to
 * `attendance-reports/components/` rather than under `attendance-tracking/`.
 */
