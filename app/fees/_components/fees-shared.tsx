...
import { AlertCircle, CheckCircle2, Loader2, Printer, X } from 'lucide-react';
...
export function ReceiptPreviewModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/45 p-4">
      <div className="flex max-h-[88vh] w-full max-w-5xl flex-col overflow-hidden rounded-xl border border-slate-200 bg-white shadow-xl">
        <div className="flex items-center justify-between gap-3 border-b border-slate-200 px-4 py-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button type="button" size="icon-sm" variant="ghost" onClick={onClose} aria-label="Close receipt preview">
              <X className="h-4 w-4" />
            </Button>
          </div>
        </div>
