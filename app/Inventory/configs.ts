...
export const configs: Record<string, InventoryConfig> = {
  ...
  negotiate_po: workflow("purchase-order-negotiations", "Negotiate PO", [
    ...
    { key: "negotiated_rate", label: "Negotiated Rate", kind: "number", required: true }, { key: "remarks", label: "Negotiation Remarks", kind: "textarea" },
    { key: "po_approval_status", label: "Approval Status", kind: "select", source: "statuses", required: true },
  ], [{ key: "po_number", label: "PO Number" }, { key: "vendor_name", label: "Vendor" }, { key: "item_name", label: "Item" }, { key: "negotiated_rate", label: "Negotiated Rate" }, { key: "status", label: "Status" }]),
  ...
  inventory_allocation: workflow("allocations", "Inventory Allocation", [
    ...dates, item, { key: "requisition_by", label: "Requisition By", kind: "select", source: "users" },
  ...
  inventory_defective: workflow("defectives", "Inventory Defective", [
    ...
    { key: "estimated_received_date", label: "Estimated Received Date", kind: "date" }, { key: "actual_received_date", label: "Actual Received Date", kind: "date" },
    { key: "remarks", label: "Remarks", kind: "textarea" },
  ], [{ key: "created_on", label: "Date" }, { key: "item_name", label: "Item" }, { key: "defect_remarks", label: "Defect" }, { key: "item_given_to", label: "Given To" }, { key: "actual_received_date", label: "Received Date" }]),
  ...
  ], [{ key: "item_code", label: "Code" }, { key: "item_name", label: "Item" }, { key: "category_name", label: "Category" }, { key: "unit_name", label: "Unit" }, { key: "stock", label: "Stock" }]),
  ...
  vendor_master: master("vendors", "Vendor Master", [
    { key: "vendor_name", label: "Vendor Name", required: true }, { key: "short_name", label: "Short Name" }, { key: "contact_number", label: "Contact Number" },
    { key: "email", label: "Email" }, { key: "address", label: "Address", kind: "textarea" }, { key: "company_name", label: "Company Name" },
    { key: "business_type", label: "Business Type" }, { key: "office_contact_person", label: "Contact Person" }, { key: "office_number", label: "Office Number" },
    { key: "office_email", label: "Office Email" }, { key: "tin_no", label: "TIN No." }, { key: "registration_no", label: "Registration No." },
  ...
  staff_wise_report: report("reports/staff-wise", "Staff Wise Report", [...dates, { key: "user_id", label: "Staff", kind: "select", source: "users", filter: true }], [{ key: "requisition_by_name", label: "Staff" }, { key: "requisition_no", label: "Requisition No." }, { key: "item_name", label: "Item" }, { key: "item_qty", label: "Requested" }, { key: "approved_qty", label: "Approved" }, { key: "category", label: "Category" }]),
  item_delivery_status_report: report("reports/delivery-status", "Item Delivery Status Report", [...dates, { key: "requisition_by", label: "Requisition By", kind: "select", source: "users", filter: true }], [{ key: "requisition_no", label: "Requisition No." }, { key: "requisition_by_name", label: "Requested By" }, { key: "item_name", label: "Item" }, { key: "item_qty", label: "Quantity" }, { key: "delivery_status", label: "Delivery Status" }, { key: "delivery_date", label: "Delivery Date" }]),
  requisition_report: report("reports/requisitions", "Requisition Report", [...dates, { key: "requisition_by", label: "Requisition By", kind: "select", source: "users", filter: true }, item, { key: "status", label: "Status", kind: "select", source: "statuses", filter: true }], [{ key: "requisition_date", label: "Date" }, { key: "user_name", label: "Requested By" }, { key: "item_name", label: "Item" }, { key: "requisition_qty", label: "Quantity" }, { key: "status", label: "Status" }]),
