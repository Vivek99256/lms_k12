...
export default function Level3Subheader({ items, parentLabel }: Level3SubheaderProps) {
    ...
    <div className="bg-white/80 backdrop-blur-xl rounded-[28px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-200/50 px-4 py-3">
      <div className="flex items-center gap-3">
        ...
        <div className="relative shrink-0">
          ...
          {showMasterDropdown && (
            <div className="absolute right-0 top-full mt-2 w-48 bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-gray-200/50 py-2 z-50">
              <button className="w-full text-left px-4 py-2.5 text-sm font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-50/80 transition-colors">
                Add New Item
              </button>
              <button className="w-full text-left px-4 py-2.5 text-sm font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-50/80 transition-colors">
                Manage Categories
              ...
              <button className="w-full text-left px-4 py-2.5 text-sm font-medium text-red-500 hover:text-red-600 hover:bg-red-50/80 transition-colors">
                Delete All
              </button>
            </div>
          )}
