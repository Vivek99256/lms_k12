...
export async function validateSsSession(request: NextRequest): Promise<{ userId: string; subInstituteId: string; syear: string; isStaff: boolean; isBearer: boolean } | null> {
