...
function ok(payload: { processed: boolean; recorded: boolean; awarded: Array<{ badgeCode: string; badgeName: string; category: string; awarded: boolean; reason: string; evidence: Record<string, unknown> }> }) {
...
export async function POST(request: NextRequest) {
    try {
        ...
        const message = err instanceof Error ? err.message : 'Failed to record badge event.';
