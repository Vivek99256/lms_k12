...
export async function GET(request: NextRequest) {
    ...
    try {
        ...
        try {
            ...
            const progress = await service.fetchChallengeProgress(challengeId, ctx);
            ...
            if (!progress) {
                return NextResponse.json({ status: '0', message: 'No progress data for this challenge.' }, { status: 404 });
            }
        ...
        const message = err instanceof Error ? err.message : 'Unable to load challenge progress.';
