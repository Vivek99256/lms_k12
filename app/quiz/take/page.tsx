...
import { Flag, ChevronRight, ChevronLeft, CheckCircle2, AlertCircle, X, Check } from 'lucide-react';
                    ...
                    return (
                      <div key={oIndex} className={`flex items-center p-4 rounded-2xl border-2 ${style}`}>
                        <div className={`w-8 h-8 rounded-xl flex items-center justify-center font-bold text-sm mr-4 
                          ...
                          {isActuallyCorrect ? <Check size={16} strokeWidth={3} /> : (isSelected && !isActuallyCorrect) ? <X size={16} strokeWidth={3} /> : letter}
                        </div>
