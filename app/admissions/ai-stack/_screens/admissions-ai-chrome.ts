...
/**
 * The chrome every Admission → AI Stack screen shares.
 *
 ...
 * admission screens could have their own identical header is how modules end up looking
 * subtly different after a design tweak lands in one of them.
 *
 * So the Admission screens import it, and this file is the seam that lets them do so
 * under names that read correctly on an admission screen. Nothing in the Fees folder is
