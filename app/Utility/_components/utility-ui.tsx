...
/**
 * Presentation primitives shared by the Utility menus. They reuse the same
 * Tailwind vocabulary as the existing utility screens (e.g. Teacher Transfer)
 * so the Utility group looks native to the app — no new design system.
 */

export const utilitySelectClass =
...
export const utilityInputClass = utilitySelectClass;

export const utilityCardClass =
...
export function UtilityAlert({ tone, children }: { tone: "error" | "success" | "info"; children: ReactNode }) {
...
export function UtilityLoading({ label }: { label: string }) {
  return (
...
export function UtilityEmpty({ title, hint }: { title: string; hint?: string }) {
  return (
...
export function UtilitySection({
  ...
  return (
    <section className={utilityCardClass}>
