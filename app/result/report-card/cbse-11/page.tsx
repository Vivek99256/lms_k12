...
/**
 * CBSE class 11 report card — fixed multi-level scholastic header (unit
 * tests, half-yearly, practicals, yearly exam, totals), co-scholastic
 * grades and attendance. Rendering is shared with the CNSE class 11 page
 * via Cbse11ReportView.
 */
...
import Cbse11ReportView, { parseCbse11Students, type Cbse11Student } from './Cbse11ReportView';
...
export default function Cbse11ReportCardPage() {
  ...
  return (
    <div className="min-h-screen p-6">
      <div className="mx-auto space-y-6">
        <PageHeader
          icon={GraduationCap}
          title="CBSE class 11 report card"
          subtitle="Unit tests, half-yearly, practical and yearly exam report cards"
          breadcrumbs={[{ label: 'Result', href: '/result' }, { label: 'Reports' }, { label: 'CBSE class 11 report card' }]}
        />
          ...
          <Card className="border-slate-200/80 bg-white shadow-sm">
            <CardHeader className="border-b border-slate-100 px-6 py-5">
              <div className="flex flex-wrap items-center justify-between gap-3">
                ...
                {students.length > 0 && (
                  <Button
                    onClick={() => printElement(printRef.current, 'CBSE class 11 report card')}
