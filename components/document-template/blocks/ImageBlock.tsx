        ...
        <OverlayWrapper isOverlay={isOverlay} x={x} y={y} width={width} height={height} rotation={rotation} zIndex={zIndex}>
            <div className="relative flex items-center justify-center p-0" style={containerStyle}>
                {src ? (
                    ...
                    <div className="w-full h-full min-h-[100px] bg-slate-100 border-0 flex flex-col items-center justify-end text-center relative overflow-hidden">
                        ...
                        <div className="w-full h-[40%] bg-slate-300 absolute bottom-0 rounded-t-[40%] transform scale-150 translate-y-2"></div>
    ...
    if (!isDesignTab) {
        return (
            <div className="flex flex-col space-y-4">
                <div>
                    <label className="text-xs font-bold text-[#0D6EFD] uppercase tracking-widest mb-2 block">Upload Image</label>
                    <input
                        type="file"
                        accept="image/*"
              ...
              file:bg-[#0D6EFD] file:text-white
        ...
        <div className="flex flex-col space-y-6">
            ...
            <div className="flex flex-col space-y-1">
                ...
                <select
                    ...
                    className="flex h-9 w-full items-center justify-between rounded-xl border border-blue-100/60 bg-white/60 hover:bg-blue-50/50 hover:border-blue-300 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none px-3 py-1 text-sm font-medium text-slate-700 shadow-sm transition-all cursor-pointer"
                >
