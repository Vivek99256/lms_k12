...
export const TextBlock = ({
    ...
    const editor = useTiptapEditor({
        ...
        editorProps: {
            attributes: {
                class: "focus:outline-none min-h-[1em] w-full break-words prose prose-sm max-w-none [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_blockquote]:border-l-4 [&_blockquote]:border-slate-300 [&_blockquote]:pl-4 [&_blockquote]:italic",
            },
        },
    });
    ...
    const toolbarButtonClass = "h-9 min-w-9 inline-flex items-center justify-center rounded-lg px-2 text-slate-700 hover:bg-slate-100 active:bg-slate-200 transition-colors";
    const activeToolbarButtonClass = "bg-[#0D6EFD] text-white";
    const toolbarGroupClass = "flex h-9 items-center gap-0.5 px-1";
    const toolbarDivider = <div className="mx-1 h-7 w-px bg-slate-200" />;
        ...
        <OverlayWrapper isOverlay={isOverlay} isText={true} x={x} y={y} width={width} height={height} rotation={rotation} zIndex={zIndex}>
            ...
            {editor && editMode && typeof document !== "undefined" && createPortal(
                ...
                >
                    ...
                    <div className={toolbarGroupClass}>
                        ...
                        {/* Font Size */}
                    <div className={`${toolbarGroupClass} rounded-lg border border-slate-200 bg-white`}>
                    ...
                    <button type="button" onMouseDown={(e) => { e.preventDefault(); cycleTextEffect(); }} className={`${toolbarButtonClass} ${textEffect !== "none" ? "bg-slate-100 text-slate-950" : ""}`} title="Effects">
                    ...
                    {toolbarDivider}
                    <button type="button" onMouseDown={(e) => { e.preventDefault(); bringToFront(); }} className={`${toolbarButtonClass} bg-slate-100 text-slate-950 hover:bg-slate-200`} title="Position">
            ...
            {textShape === 'curve' && !editMode ? (
                ...
                <div
                    ...
                    className={`relative p-2 ${editMode ? "ring-2 ring-blue-400 ring-offset-1 rounded-sm" : ""} cursor-text [&_p]:m-0`}
                >
                ...
                <div className="space-y-2">
                    ...
                    <div className="flex items-center space-x-2 pb-2">
                        <div className="flex items-center border border-input rounded overflow-hidden">
                            ...
                            />
                            <div className="h-8 flex items-center px-2 bg-slate-100 text-xs text-muted-foreground border-l border-input">px</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="grid grid-cols-3 gap-2">
                    {[
                        ...
                        <button
                            ...
                            className={`flex flex-col items-center justify-center p-2 rounded-xl border transition-all ${props.textEffect === effect.id ? 'border-blue-400 bg-blue-50/50 ring-1 ring-blue-400 shadow-[0_4px_12px_rgba(14,165,233,0.15)]' : 'border-blue-100/60 hover:border-blue-300 bg-white/60 hover:bg-blue-50/50 shadow-sm hover:shadow'}`}
                        >
                            <span className="text-xl font-bold font-sans text-slate-800 mb-1 pointer-events-none" style={
                ...
                <div className="grid grid-cols-2 gap-2">
                    {[
                        ...
                        <button
                            ...
                            className={`flex flex-col items-center justify-center p-4 rounded-xl border transition-all ${props.textShape === shape.id ? 'border-blue-400 bg-blue-50/50 ring-1 ring-blue-400 shadow-[0_4px_12px_rgba(14,165,233,0.15)]' : 'border-blue-100/60 hover:border-blue-300 bg-white/60 hover:bg-blue-50/50 shadow-sm hover:shadow'}`}
                        >
                            <span className="text-xl font-bold font-sans text-slate-800 mb-2 pointer-events-none" style={shape.id === 'curve' ? { transform: 'rotate(-10deg) translateY(5px)' } : {}}>{shape.preview}</span>
