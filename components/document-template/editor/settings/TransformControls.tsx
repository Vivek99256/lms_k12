        ...
        <div className={`relative w-full h-full group/transform`}>
            ...
            <div className={`absolute inset-0 pointer-events-none ${(selected || isHovered) ? 'opacity-100' : 'opacity-0'} transition-opacity duration-150`}>
                ...
                <div className="absolute top-full left-1/2 -translate-x-1/2 flex items-center gap-[6px] pointer-events-auto z-[9999] select-none">
                    {/* Rotate Button */}
                    <div
                        className="w-[40px] h-[40px] rounded-full bg-white shadow-sm border border-slate-200 text-slate-600 flex items-center justify-center cursor-grab active:cursor-grabbing hover:bg-slate-50 transition-colors transform-handle"
                    ...
                    {/* Move Button */}
                    <div
                        className="w-[40px] h-[40px] rounded-full bg-white shadow-sm border border-slate-200 text-slate-600 flex items-center justify-center cursor-grab active:cursor-grabbing hover:bg-slate-50 transition-colors move-handle pointer-events-auto"
                    ...
                    {controls.onDelete && (
                        <div
                            className="w-[40px] h-[40px] rounded-full bg-white shadow-sm border border-slate-200 text-red-500 flex items-center justify-center cursor-pointer hover:bg-red-50 hover:border-red-200 transition-colors transform-handle pointer-events-auto"
